function param_grid = sweep_grid_cfd()
    ...
    param_grid = [
        ...
        0.30      0.06     0.001     20      3      3      2
        0.40      0.08     0.001     20      3      4      3
        0.50      0.10     0.001     20      3      5      4

        % Top targets = 3, current neighborhood
        0.30      0.06     0.001     20      3      5      4
        0.40      0.08     0.001     20      3      5      4
        0.50      0.10     0.001     20      3      6      5

        % Top targets = 3, more inputs / richer
        0.20      0.04     0.001     20      3      6      5
        0.40      0.08     0.001     20      3      8      6
        0.80      0.16     0.001     20      3      8      6

        % Top targets = 3, gamma sensitivity
        0.40      0.08     0.005     20      3      5      4
        0.40      0.08     0.010     20      3      5      4
        0.40      0.08     0.050     20      3      5      4

        % Top targets = 4, conservative
        0.30      0.06     0.001     20      4      3      2
        0.40      0.08     0.001     20      4      4      3
        0.50      0.10     0.001     20      4      5      4

        % Top targets = 4, current neighborhood
        0.30      0.06     0.001     20      4      5      4
        0.40      0.08     0.001     20      4      5      4
        0.50      0.10     0.001     20      4      6      5

        % Top targets = 4, more inputs / richer
        0.20      0.04     0.001     20      4      6      5
        0.40      0.08     0.001     20      4      8      6
        0.80      0.16     0.001     20      4      8      6

        % Top targets = 4, gamma sensitivity
        0.40      0.08     0.005     20      4      5      4
        0.40      0.08     0.010     20      4      5      4
        0.40      0.08     0.050     20      4      5      4
        ]; 
